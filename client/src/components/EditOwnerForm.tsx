...
import { EditOwnerFormProps } from '../types';


const EditOwnerForm: React.FC<EditOwnerFormProps> = ({ isOpen, onClose, owner, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await ownerAPI.update(owner.OwnerID, ownerData);
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20">
        ...
        {/* Modal */}
        <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full p-6 z-50 max-h-[90vh] overflow-y-auto">
          {/* Header */}
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-gray-900">Edit Owner</h2>
          ...
          {success && (
            <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-4">
              <div className="flex items-center">
                ...
                <p className="font-medium">Owner updated successfully!</p>
              </div>
            </div>
          )}
